...
class Soul extends StatefulWidget {
  ...
  @override
  State<Soul> createState() => _SoulScreenState();
}

class _SoulScreenState extends State<Soul> {
                  ...
                  title: GestureDetector(
                      onTap: () {
                        CoolAlert.show(
                            ...
                            title: soulData[index].word,
                            text: soulData[index].descriptions);
                      },
                      child: Text(soulData[index].word,
