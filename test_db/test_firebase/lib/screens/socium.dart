...
class Socium extends StatefulWidget {
  int index;
  List<Termin> data;
  String name;
  ...
  @override
  State<Socium> createState() => _SociumScreenState();
}

class _SociumScreenState extends State<Socium> {
                  ...
                  title: GestureDetector(
                      onTap: () {
                        CoolAlert.show(
                            ...
                            title: sociumData[index].word,
                            text: sociumData[index].descriptions);
                      },
                      child: Text(sociumData[index].word,
